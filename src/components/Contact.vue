    ...
    <div class="max-w-7xl mx-auto">
      <div class="reveal-element text-center mb-16">
        ...
        <p class="text-slate-400 max-w-2xl mx-auto">
          Have a project in mind or just want to say hi? Feel free to reach out through the form or my social media.
        </p>
      </div>
          ...
          <div class="space-y-8">
            <div class="flex items-center gap-5 group">
              ...
              <div>
                ...
                <p class="text-white font-semibold text-lg hover:text-accent transition-colors duration-300">
                  hello@example.com
                </p>
              </div>
            </div>
        ...
        <div class="md:col-span-7 reveal-element reveal-right delay-300">
          ...
          >
            ...
            <form class="space-y-8 relative z-10">
              ...
              <button
                type="button"
                class="btn-shimmer w-full py-4 bg-accent text-primary font-bold rounded-xl transition-all duration-300 active:scale-[0.98] relative overflow-hidden group/btn"
              >
...
@keyframes float-slow-2 {
  ...
  50% { transform: translate(25%, calc(25% - 25px)); }
}
...
.wrapper .facebook:hover:after { background-color: #1877f2; }
.wrapper .twitter:hover:after { background-color: #1da1f2; }
.wrapper .instagram:hover:after { background-color: #e4405f; }

.wrapper .facebook:hover .tooltip, .wrapper .facebook:hover .tooltip::before { background: #1877f2; }
.wrapper .twitter:hover .tooltip, .wrapper .twitter:hover .tooltip::before { background: #1da1f2; }
.wrapper .instagram:hover .tooltip, .wrapper .instagram:hover .tooltip::before { background: #e4405f; }
</style>
